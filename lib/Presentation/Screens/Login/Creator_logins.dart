...
class CreatorLogins extends StatefulWidget {
  const CreatorLogins({super.key});

  @override
  State<CreatorLogins> createState() => _CreatorLoginsState();
}

class _CreatorLoginsState extends State<CreatorLogins> {
  bool _obscure = true;
